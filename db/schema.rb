...
ActiveRecord::Schema.define(version: 20_220_630_082_712) do
  create_table 'active_admin_comments', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci',
                                        force: :cascade do |t|
    t.string 'namespace'
    t.text 'body'
  ...
  create_table 'admin_users', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci',
                              force: :cascade do |t|
